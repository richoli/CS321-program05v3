...
public:
	...
	BSTNode(const T& lat, const T& lon, BSTNode<T> *NW = 0, BSTNode<T> *NE = 0, BSTNode<T> *SW = 0, BSTNode<T> *SE = 0) {
		this.lat = lat; this.lon = lon; this.NW = NW; this.NE = NE; this.SW = SW; this.SE = SE;
	}
	T cityName, lat, lon;
...
template<class T>
void BST<T>::insert(const T& cityName, const T& lat, const T& lon) {
